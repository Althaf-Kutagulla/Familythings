...
public class GoogleCalenderAPI {
    ...
    public void setNewEvent(String summary,String location,String description,String startDateTimeP,String endDateTimeP) throws IOException, GeneralSecurityException {
    ...
    public static void main(String args[]) throws IOException, GeneralSecurityException {
    	GoogleCalenderAPI cal = new GoogleCalenderAPI();
    	List<Event> list =cal.getEvents();
    	System.out.println(list);
    	cal.setNewEvent("Family Eventc","Kadirix","Dinnerf","2023-12-11T10:00","2023-12-11T11:00");
    }
